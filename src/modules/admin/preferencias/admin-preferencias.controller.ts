...
export class AdminPreferenciasController {
  ...
  @Get()
  @ApiOperation({ summary: 'Obtém preferências do admin (PreferenciasAdmin)', description: 'Returns admin preferences' })
  ...
  @Patch()
  @ApiOperation({ summary: 'Atualiza preferências (notificações, taxaEntregaPadrao, metodosPagamentoAtivos)', description: 'Updates preferences' })
