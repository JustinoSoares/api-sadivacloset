...
describe('AdminOrdersService', () => {
  ...
  it('should paginate with filtros estado e data', async () => {
    ...
    dto.page = 1;
    dto.limit = 20;
    // force normalized via getter: need to set estado to map correctly, but service uses getter
  ...
  it('should paginate with intervalo de data', async () => {
  ...
  it('should update estado, gravar audit e notificar', async () => {
